 ...
 * @since       2.4.5
 */
class FetchTweets_AdminPage_Extension_FeedList extends FetchTweets_AdminPage_Tab_Base {
     ...
     * @since       2.4.5
     */
    private $_sFeedURL = 'http://feeds.feedburner.com/MiunosoftFetchTweetsExtension';
    ...
    public function replyToDoTab( $oFactory ) {
        ...
        private function _getListOfFeedItems() {
            ...
            if ( empty( $_aFeedItems ) ) {
                return "<h3>" 
                        . __( 'No extension has been found.', 'fetch-tweets' ) 
                    . "</h3>";
            }
            ...
            return '<div class="ftws_extension_container">'
                . '<div class="' . $_aColumnOption['sClassAttr'] . ' '
