...
abstract class FetchTweets_AdminPageFramework_Factory_Router {
    ...
    protected $_aFormElementClassNameMap = array('page' => 'FetchTweets_AdminPageFramework_FormElement_Page', 'network_admin_page' => 'FetchTweets_AdminPageFramework_FormElement_Page', 'post_meta_box' => 'FetchTweets_AdminPageFramework_FormElement_Meta', 'page_meta_box' => 'FetchTweets_AdminPageFramework_FormElement', 'post_type' => 'FetchTweets_AdminPageFramework_FormElement', 'taxonomy' => 'FetchTweets_AdminPageFramework_FormElement', 'widget' => 'FetchTweets_AdminPageFramework_FormElement', 'user_meta' => 'FetchTweets_AdminPageFramework_FormElement_Meta',);
    ...
    protected $_aResourceClassNameMap = array('page' => 'FetchTweets_AdminPageFramework_Resource_Page', 'network_admin_page' => 'FetchTweets_AdminPageFramework_Resource_Page', 'post_meta_box' => 'FetchTweets_AdminPageFramework_Resource_MetaBox', 'page_meta_box' => 'FetchTweets_AdminPageFramework_Resource_MetaBox_Page', 'post_type' => 'FetchTweets_AdminPageFramework_Resource_PostType', 'taxonomy' => 'FetchTweets_AdminPageFramework_Resource_TaxonomyField', 'widget' => 'FetchTweets_AdminPageFramework_Resource_Widget', 'user_meta' => 'FetchTweets_AdminPageFramework_Resource_UserMeta',);
    ...
    protected $_aHelpPaneClassNameMap = array('page' => 'FetchTweets_AdminPageFramework_HelpPane_Page', 'network_admin_page' => 'FetchTweets_AdminPageFramework_HelpPane_Page', 'post_meta_box' => 'FetchTweets_AdminPageFramework_HelpPane_MetaBox', 'page_meta_box' => 'FetchTweets_AdminPageFramework_HelpPane_MetaBox_Page', 'post_type' => null, 'taxonomy' => 'FetchTweets_AdminPageFramework_HelpPane_TaxonomyField', 'widget' => 'FetchTweets_AdminPageFramework_HelpPane_Widget', 'user_meta' => 'FetchTweets_AdminPageFramework_HelpPane_UserMeta',);
    ...
    protected $_aLinkClassNameMap = array('page' => 'FetchTweets_AdminPageFramework_Link_Page', 'network_admin_page' => 'FetchTweets_AdminPageFramework_Link_NetworkAdmin', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'FetchTweets_AdminPageFramework_Link_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    protected $_aPageLoadClassNameMap = array('page' => 'FetchTweets_AdminPageFramework_PageLoadInfo_Page', 'network_admin_page' => 'FetchTweets_AdminPageFramework_PageLoadInfo_NetworkAdminPage', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'FetchTweets_AdminPageFramework_PageLoadInfo_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
