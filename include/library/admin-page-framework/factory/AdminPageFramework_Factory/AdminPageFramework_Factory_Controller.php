...
abstract class FetchTweets_AdminPageFramework_Factory_Controller extends FetchTweets_AdminPageFramework_Factory_View {
    ...
    public function setFieldErrors($aErrors) {
        $GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors'] = $this->oUtil->getElement($GLOBALS, array('aFetchTweets_AdminPageFramework', 'aFieldErrors'), array());
    ...
    public function setSettingNotice($sMessage, $sType = 'error', $asAttributes = array(), $bOverride = true) {
        $GLOBALS['aFetchTweets_AdminPageFramework']['aNotices'] = $this->oUtil->getElement($GLOBALS, array('aFetchTweets_AdminPageFramework', 'aNotices'), array());
    ...
    public function hasSettingNotice($sType = '') {
        $_aNotices = $this->oUtil->getElementAsArray($GLOBALS, array('aFetchTweets_AdminPageFramework', 'aNotices'), array());
        if (!$sType) {
