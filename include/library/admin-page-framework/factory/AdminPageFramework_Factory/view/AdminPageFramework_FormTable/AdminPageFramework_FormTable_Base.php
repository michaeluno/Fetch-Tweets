...
JAVASCRIPTS;
    ...
    protected function _getDebugInfo($sFieldsType) {
        ...
        return "<div class='admin-page-framework-info'>" . 'Debug Info: ' . FetchTweets_AdminPageFramework_Registry::NAME . ' ' . FetchTweets_AdminPageFramework_Registry::getVersion() . "</div>";
    }
}