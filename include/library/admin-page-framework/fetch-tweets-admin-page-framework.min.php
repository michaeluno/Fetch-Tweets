...
final class FetchTweets_AdminPageFramework_Registry extends FetchTweets_AdminPageFramework_Registry_Base {
    ...
    static function setUp($sFilePath = null) {
        ...
        self::$sAutoLoaderPath = self::$sDirPath . '/factory/FetchTweets_AdminPageFramework_Factory/utility/FetchTweets_AdminPageFramework_RegisterClasses.php';
        self::$bIsMinifiedVersion = class_exists('FetchTweets_AdminPageFramework_MinifiedVersionHeader');
    }
...
final class FetchTweets_AdminPageFramework_Bootstrap {
    function __construct($sLibraryPath) {
        ...
        new FetchTweets_AdminPageFramework_RegisterClasses(isset($aClassFiles) ? '' : FetchTweets_AdminPageFramework_Registry::$sDirPath, array('exclude_class_names' => 'FetchTweets_AdminPageFramework_MinifiedVersionHeader',), isset($aClassFiles) ? $aClassFiles : array());
    }
}
...
abstract class FetchTweets_AdminPageFramework_Factory_Router {
    ...
    protected function _getLinkInstancce($oProp, $oMsg) {
        switch ($oProp->sFieldsType) {
            ...
            case 'network_admin_page':
                return new FetchTweets_AdminPageFramework_Link_NetworkAdmin($oProp, $oMsg);
            case 'post_meta_box':
                return null;
            case 'page_meta_box':
                return null;
...
final class FetchTweets_AdminPageFramework_MinifiedVersionHeader extends FetchTweets_AdminPageFramework_Registry_Base {
...
class FetchTweets_AdminPageFramework_Link_NetworkAdmin extends FetchTweets_AdminPageFramework_Link_Page {
    public $oProp;
    public function __construct(&$oProp, $oMsg = null) {
        if (!$oProp->bIsAdmin) {
            return;
...
class FetchTweets_AdminPageFramework_Widget_Factory extends WP_Widget {
    ...
    public function form($aFormData) {
        ...
        $this->oCaller->oForm = new FetchTweets_AdminPageFramework_FormElement($this->oCaller->oProp->sFieldsType, $this->oCaller->oProp->sCapability, $this->oCaller);
    }
...
class FetchTweets_AdminPageFramework_AdminNotice {
