...
final class FetchTweets_AdminPageFramework_Registry extends FetchTweets_AdminPageFramework_Registry_Base {
    ...
    static function setUp($sFilePath = null) {
        ...
        self::$sAutoLoaderPath = self::$sDirPath . '/utility/FetchTweets_AdminPageFramework_RegisterClasses.php';
...
final class FetchTweets_AdminPageFramework_Bootstrap {
    function __construct($sLibraryPath) {
        ...
        if (!FetchTweets_AdminPageFramework_Registry::$bIsMinifiedVersion) {
            ...
            include (FetchTweets_AdminPageFramework_Registry::$sDirPath . '/admin-page-framework-include-class-list.php');
            new FetchTweets_AdminPageFramework_RegisterClasses(isset($aClassFiles) ? '' : FetchTweets_AdminPageFramework_Registry::$sDirPath, array(), isset($aClassFiles) ? $aClassFiles : array());
        }
    }
}
new FetchTweets_AdminPageFramework_Bootstrap(__FILE__);
class FetchTweets_AdminPageFramework_Documentaiton {
}
class FetchTweets_AdminPageFramework_Factory_Documentaiton {
}
abstract class FetchTweets_AdminPageFramework_FieldType_Documentation {
}
abstract class FetchTweets_AdminPageFramework_MetaBox_Documentation {
}
abstract class FetchTweets_AdminPageFramework_MetaBox_Page_Documentation {
}
if (!class_exists('FetchTweets_AdminPageFramework_NetworkAdmin_Documentation')):
    abstract class FetchTweets_AdminPageFramework_NetworkAdmin_Documentation {
    }
endif;
abstract class FetchTweets_AdminPageFramework_PostType_Documentation {
}
abstract class FetchTweets_AdminPageFramework_TaxonomyField_Documentaion {
}
abstract class FetchTweets_AdminPageFramework_Widget_Documentation {
}
abstract class FetchTweets_AdminPageFramework_Factory_Router {
    ...
    protected function _getFormInstance($oProp) {
        switch ($oProp->sFieldsType) {
            ...
            case 'network_admin_page':
                ...
                return new FetchTweets_AdminPageFramework_FormElement_Page($oProp->sFieldsType, $oProp->sCapability, $this);
            case 'post_meta_box':
            case 'page_meta_box':
            case 'post_type':
                if ($oProp->bIsAdminAjax) {
                ...
                return new FetchTweets_AdminPageFramework_FormElement($oProp->sFieldsType, $oProp->sCapability, $this);
            case 'taxonomy':
            case 'widget':
            case 'user_meta':
                return new FetchTweets_AdminPageFramework_FormElement($oProp->sFieldsType, $oProp->sCapability, $this);
    ...
    protected function _getResourceInstance($oProp) {
        switch ($oProp->sFieldsType) {
            case 'page':
            case 'network_admin_page':
                return new FetchTweets_AdminPageFramework_Resource_Page($oProp);
            case 'post_meta_box':
                return new FetchTweets_AdminPageFramework_Resource_MetaBox($oProp);
            case 'page_meta_box':
                return new FetchTweets_AdminPageFramework_Resource_MetaBox_Page($oProp);
            case 'post_type':
                return new FetchTweets_AdminPageFramework_Resource_PostType($oProp);
            case 'taxonomy':
                return new FetchTweets_AdminPageFramework_Resource_TaxonomyField($oProp);
            case 'widget':
                return new FetchTweets_AdminPageFramework_Resource_Widget($oProp);
            case 'user_meta':
                return new FetchTweets_AdminPageFramework_Resource_UserMeta($oProp);
        }
    }
    protected function _getHelpPaneInstance($oProp) {
        switch ($oProp->sFieldsType) {
            case 'page':
            case 'network_admin_page':
                return new FetchTweets_AdminPageFramework_HelpPane_Page($oProp);
            case 'post_meta_box':
                return new FetchTweets_AdminPageFramework_HelpPane_MetaBox($oProp);
            case 'page_meta_box':
                return new FetchTweets_AdminPageFramework_HelpPane_MetaBox_Page($oProp);
            case 'post_type':
                return null;
            case 'taxonomy':
                return new FetchTweets_AdminPageFramework_HelpPane_TaxonomyField($oProp);
            case 'widget':
                return new FetchTweets_AdminPageFramework_HelpPane_Widget($oProp);
            case 'user_meta':
                return new FetchTweets_AdminPageFramework_HelpPane_UserMeta($oProp);
        }
    }
    protected function _getLinkInstancce($oProp, $oMsg) {
        switch ($oProp->sFieldsType) {
            case 'page':
            case 'network_admin_page':
                return new FetchTweets_AdminPageFramework_Link_Page($oProp, $oMsg);
            case 'post_meta_box':
                return null;
            case 'page_meta_box':
                return null;
            case 'post_type':
                return new FetchTweets_AdminPageFramework_Link_PostType($oProp, $oMsg);
            default:
            case 'taxonomy':
            case 'widget':
            case 'user_meta':
    ...
    protected function _getPageLoadInfoInstance($oProp, $oMsg) {
        switch ($oProp->sFieldsType) {
            case 'page':
                return FetchTweets_AdminPageFramework_PageLoadInfo_Page::instantiate($oProp, $oMsg);
            case 'network_admin_page':
                return FetchTweets_AdminPageFramework_PageLoadInfo_NetworkAdminPage::instantiate($oProp, $oMsg);
            case 'post_meta_box':
                return null;
            case 'page_meta_box':
                return null;
            case 'post_type':
                return FetchTweets_AdminPageFramework_PageLoadInfo_PostType::instantiate($oProp, $oMsg);
            default:
            case 'taxonomy':
            case 'widget':
                return null;
    ...
    function __get($sPropertyName) {
        switch ($sPropertyName) {
            ...
            case 'oDebug':
                ...
                return $this->oDebug;
            case 'oMsg':
                $this->oMsg = FetchTweets_AdminPageFramework_Message::getInstance($this->oProp->sTextDomain);
                return $this->oMsg;
            case 'oForm':
...
abstract class FetchTweets_AdminPageFramework_Factory_Model extends FetchTweets_AdminPageFramework_Factory_Router {
    ...
    public function _loadDefaultFieldTypeDefinitions() {
        if (empty(self::$_aFieldTypeDefinitions)) {
            self::$_aFieldTypeDefinitions = FetchTweets_AdminPageFramework_FieldTypeRegistration::register(array(), $this->oProp->sClassName, $this->oMsg);
        }
    ...
    private function _registerField(array $aField) {
        FetchTweets_AdminPageFramework_FieldTypeRegistration::_setFieldResources($aField, $this->oProp, $this->oResource);
        if ($aField['help']) {
    ...
    protected function _isValidationErrors() {
        if (isset($GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors']) && $GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors']) {
            return true;
        }
    ...
    public function _replyToSaveFieldErrors() {
        if (!isset($GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors'])) {
            return;
        }
        $this->oUtil->setTransient("apf_field_erros_" . get_current_user_id(), $GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors'], 300);
    }
    public function _replyToSaveNotices() {
        if (!isset($GLOBALS['aFetchTweets_AdminPageFramework']['aNotices'])) {
            return;
        }
        if (empty($GLOBALS['aFetchTweets_AdminPageFramework']['aNotices'])) {
            return;
        }
        $this->oUtil->setTransient('apf_notices_' . get_current_user_id(), $GLOBALS['aFetchTweets_AdminPageFramework']['aNotices']);
    }
...
abstract class FetchTweets_AdminPageFramework_Factory_View extends FetchTweets_AdminPageFramework_Factory_Model {
    ...
    public function _replyToGetFieldOutput($aField) {
        $_oField = new FetchTweets_AdminPageFramework_FormField($aField, $this->oProp->aOptions, $this->_getFieldErrors(), $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
...
abstract class FetchTweets_AdminPageFramework_Factory_Controller extends FetchTweets_AdminPageFramework_Factory_View {
    ...
    public function setFieldErrors($aErrors) {
        $GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors'] = isset($GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors']) ? $GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors'] : array();
        if (empty($GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors'])) {
            add_action('shutdown', array($this, '_replyToSaveFieldErrors'));
        }
        $_sID = md5($this->oProp->sClassName);
        $GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors'][$_sID] = isset($GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors'][$_sID]) ? $this->oUtil->uniteArrays($GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors'][$_sID], $aErrors) : $aErrors;
    }
    public function hasFieldError() {
        return isset($GLOBALS['aFetchTweets_AdminPageFramework']['aFieldErrors'][md5($this->oProp->sClassName) ]);
    }
    public function setSettingNotice($sMessage, $sType = 'error', $asAttributes = array(), $bOverride = true) {
        $GLOBALS['aFetchTweets_AdminPageFramework']['aNotices'] = isset($GLOBALS['aFetchTweets_AdminPageFramework']['aNotices']) ? $GLOBALS['aFetchTweets_AdminPageFramework']['aNotices'] : array();
        if (empty($GLOBALS['aFetchTweets_AdminPageFramework']['aNotices'])) {
            add_action('shutdown', array($this, '_replyToSaveNotices'));
        }
        $_sID = md5(trim($sMessage));
        if ($bOverride || !isset($GLOBALS['aFetchTweets_AdminPageFramework']['aNotices'][$_sID])) {
            ...
            $GLOBALS['aFetchTweets_AdminPageFramework']['aNotices'][$_sID] = array('sMessage' => $sMessage, 'aAttributes' => $_aAttributes + array('class' => $sType, 'id' => $this->oProp->sClassName . '_' . $_sID,),);
        }
    }
    public function hasSettingNotice($sType = '') {
        $_aNotices = isset($GLOBALS['aFetchTweets_AdminPageFramework']['aNotices']) ? $GLOBALS['aFetchTweets_AdminPageFramework']['aNotices'] : array();
        if (!$sType) {
...
abstract class FetchTweets_AdminPageFramework_Router extends FetchTweets_AdminPageFramework_Factory {
    ...
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = isset($this->oProp) ? $this->oProp : new FetchTweets_AdminPageFramework_Property_Page($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
...
abstract class FetchTweets_AdminPageFramework_Form_Model_Port extends FetchTweets_AdminPageFramework_Router {
    ...
    protected function _exportOptions($vData, $sPageSlug, $sTabSlug) {
        $oExport = new FetchTweets_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
...
abstract class FetchTweets_AdminPageFramework_MetaBox_Router extends FetchTweets_AdminPageFramework_Factory {
    function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        ...
        $_sClassName = get_class($this);
        parent::__construct(isset($this->oProp) ? $this->oProp : new FetchTweets_AdminPageFramework_Property_MetaBox($this, $_sClassName, $sCapability));
...
abstract class FetchTweets_AdminPageFramework_MetaBox_Model extends FetchTweets_AdminPageFramework_MetaBox_Router {
    ...
    protected function _setOptionArray($iPostID, $aFields) {
        ...
        $this->oProp->aOptions = FetchTweets_AdminPageFramework_WPUtility::addAndApplyFilter($this, 'options_' . $this->oProp->sClassName, $this->oProp->aOptions);
        $_aLastInput = isset($_GET['field_errors']) && $_GET['field_errors'] ? $this->oProp->aLastInput : array();
        $this->oProp->aOptions = empty($this->oProp->aOptions) ? array() : FetchTweets_AdminPageFramework_WPUtility::getAsArray($this->oProp->aOptions);
...
abstract class FetchTweets_AdminPageFramework_TaxonomyField_Router extends FetchTweets_AdminPageFramework_Factory {
...
abstract class FetchTweets_AdminPageFramework_TaxonomyField_Model extends FetchTweets_AdminPageFramework_TaxonomyField_Router {
...
abstract class FetchTweets_AdminPageFramework_UserMeta_Router extends FetchTweets_AdminPageFramework_Factory {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
            add_action('wp_loaded', array($this, '_replyToDetermineToLoad'));
...
abstract class FetchTweets_AdminPageFramework_UserMeta_Model extends FetchTweets_AdminPageFramework_UserMeta_Router {
    public function _replyToRegisterFormElements($oScreen) {
        $this->_loadDefaultFieldTypeDefinitions();
        $this->oForm->format();
        $this->oForm->applyConditions();
    ...
    protected function _setOptionArray($iUserID) {
        ...
        $_aOptions = FetchTweets_AdminPageFramework_WPUtility::addAndApplyFilter($this, 'options_' . $this->oProp->sClassName, $_aOptions);
        $_aLastInput = isset($_GET['field_errors']) && $_GET['field_errors'] ? $this->oProp->aLastInput : array();
        $_aOptions = empty($_aOptions) ? array() : FetchTweets_AdminPageFramework_WPUtility::getAsArray($_aOptions);
...
abstract class FetchTweets_AdminPageFramework_Widget_Model extends FetchTweets_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new FetchTweets_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, is_array($this->oProp->aWidgetArguments) ? $this->oProp->aWidgetArguments : array());
    }
...
abstract class FetchTweets_AdminPageFramework_Form_Model_Validation extends FetchTweets_AdminPageFramework_Form_Model_Port {
...
abstract class FetchTweets_AdminPageFramework_Form_Model extends FetchTweets_AdminPageFramework_Form_Model_Validation {
    ...
    public function _replyToRegisterSettings() {
        ...
        $this->oForm->applyFiltersToFields($this, $this->oProp->sClassName);
        $this->oForm->setDynamicElements($this->oProp->aOptions);
        $this->oProp->aFieldTypeDefinitions = FetchTweets_AdminPageFramework_FieldTypeRegistration::register($this->oProp->aFieldTypeDefinitions, $this->oProp->sClassName, $this->oMsg);
            ...
            foreach ($_aSubSectionOrFields as $_sSubSectionIndexOrFieldID => $_aSubSectionOrField) {
                if (is_numeric($_sSubSectionIndexOrFieldID) && is_int($_sSubSectionIndexOrFieldID + 0)) {
                    ...
                    foreach ($_aSubSection as $__sFieldID => $__aField) {
                        FetchTweets_AdminPageFramework_FieldTypeRegistration::_setFieldResources($__aField, $this->oProp, $this->oResource);
                    }
                    continue;
                }
...
abstract class FetchTweets_AdminPageFramework_MetaBox_View extends FetchTweets_AdminPageFramework_MetaBox_Model {
    public function _replyToPrintMetaBoxContents($oPost, $vArgs) {
        ...
        $_oFieldsTable = new FetchTweets_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->_getFieldErrors(), $this->oMsg);
...
abstract class FetchTweets_AdminPageFramework_MetaBox extends FetchTweets_AdminPageFramework_MetaBox_Controller {
    ...
    function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new FetchTweets_AdminPageFramework_Property_MetaBox($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class FetchTweets_AdminPageFramework_TaxonomyField_View extends FetchTweets_AdminPageFramework_TaxonomyField_Model {
...
abstract class FetchTweets_AdminPageFramework_TaxonomyField_Controller extends FetchTweets_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class FetchTweets_AdminPageFramework_TaxonomyField extends FetchTweets_AdminPageFramework_TaxonomyField_Controller {
    ...
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new FetchTweets_AdminPageFramework_Property_TaxonomyField($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class FetchTweets_AdminPageFramework_UserMeta_View extends FetchTweets_AdminPageFramework_UserMeta_Model {
    public function content($sContent) {
        return $sContent;
    }
...
abstract class FetchTweets_AdminPageFramework_UserMeta_Controller extends FetchTweets_AdminPageFramework_UserMeta_View {
    public function setUp() {
    }
    public function enqueueStyles($aSRCs, $aPostTypes = array(), $aCustomArgs = array()) {
        return $this->oResource->_enqueueStyles($aSRCs, $aPostTypes, $aCustomArgs);
...
abstract class FetchTweets_AdminPageFramework_UserMeta extends FetchTweets_AdminPageFramework_UserMeta_Controller {
    ...
    public function __construct($sCapability = 'edit_user', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new FetchTweets_AdminPageFramework_Property_UserMeta($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
        parent::__construct($this->oProp);
        $this->oUtil->addAndDoAction($this, "start_{$this->oProp->sClassName}");
    }
}
...
abstract class FetchTweets_AdminPageFramework_Widget extends FetchTweets_AdminPageFramework_Widget_Controller {
    ...
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new FetchTweets_AdminPageFramework_Property_Widget($this, null, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class FetchTweets_AdminPageFramework_Form_View extends FetchTweets_AdminPageFramework_Form_Model {
    public function _replyToGetSectionHeaderOutput($sSectionDescription, $aSection) {
        return $this->oUtil->addAndApplyFilters($this, array('section_head_' . $this->oProp->sClassName . '_' . $aSection['section_id']), $sSectionDescription);
    }
    public function _replyToGetFieldOutput($aField) {
        ...
        $_oField = new FetchTweets_AdminPageFramework_FormField($aField, $_aTemp, $this->aFieldErrors, $this->oProp->aFieldTypeDefinitions, $this->oMsg);
...
abstract class FetchTweets_AdminPageFramework_Form_Controller extends FetchTweets_AdminPageFramework_Form_View {
    public function addSettingSections($aSection1, $aSection2 = null, $_and_more = null) {
        foreach (func_get_args() as $asSection) {
            $this->addSettingSection($asSection);
        }
    ...
    public function getValue() {
        ...
        return FetchTweets_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, $_aParams, null, $this->getSavedOptions() + $this->oProp->getDefaultOptions($this->oForm->aFields));
    }
...
abstract class FetchTweets_AdminPageFramework_MetaBox_Page_Router extends FetchTweets_AdminPageFramework_MetaBox_View {
...
abstract class FetchTweets_AdminPageFramework_MetaBox_Page_Model extends FetchTweets_AdminPageFramework_MetaBox_Page_Router {
    static protected $_sFieldsType = 'page_meta_box';
    function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new FetchTweets_AdminPageFramework_Property_MetaBox_Page($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class FetchTweets_AdminPageFramework_Page_Model extends FetchTweets_AdminPageFramework_Form_Controller {
...
abstract class FetchTweets_AdminPageFramework_MetaBox_Page_View extends FetchTweets_AdminPageFramework_MetaBox_Page_Model {
}
abstract class FetchTweets_AdminPageFramework_MetaBox_Page_Controller extends FetchTweets_AdminPageFramework_MetaBox_Page_View {
...
abstract class FetchTweets_AdminPageFramework_MetaBox_Page extends FetchTweets_AdminPageFramework_MetaBox_Page_Controller {
    function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
...
abstract class FetchTweets_AdminPageFramework_Page_View_MetaBox extends FetchTweets_AdminPageFramework_Page_Model {
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aFetchTweets_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aFetchTweets_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aFetchTweets_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aFetchTweets_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aFetchTweets_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
...
abstract class FetchTweets_AdminPageFramework_Page_View extends FetchTweets_AdminPageFramework_Page_View_MetaBox {
    ...
    private function _printMainContent($sPageSlug, $sTabSlug) {
        ...
        if ($this->oProp->bEnableForm && $this->oForm->isPageAdded($sPageSlug)) {
            ...
            $_oFieldsTable = new FetchTweets_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->aFieldErrors, $this->oMsg);
...
abstract class FetchTweets_AdminPageFramework_Page_Controller extends FetchTweets_AdminPageFramework_Page_View {
...
abstract class FetchTweets_AdminPageFramework_Menu_Model extends FetchTweets_AdminPageFramework_Page_Controller {
...
abstract class FetchTweets_AdminPageFramework_Menu_View extends FetchTweets_AdminPageFramework_Menu_Model {
}
abstract class FetchTweets_AdminPageFramework_Menu_Controller extends FetchTweets_AdminPageFramework_Menu_View {
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
...
abstract class FetchTweets_AdminPageFramework_Model extends FetchTweets_AdminPageFramework_Menu_Controller {
}
...
abstract class FetchTweets_AdminPageFramework extends FetchTweets_AdminPageFramework_Controller {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        parent::__construct($sOptionKey, $sCallerPath ? trim($sCallerPath) : $sCallerPath = (is_admin() && (isset($GLOBALS['pagenow']) && in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page'])) ? FetchTweets_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null), $sCapability, $sTextDomain);
        $this->oUtil->addAndDoAction($this, 'start_' . $this->oProp->sClassName, $this);
    }
}
abstract class FetchTweets_AdminPageFramework_NetworkAdmin extends FetchTweets_AdminPageFramework {
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return FetchTweets_AdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class FetchTweets_AdminPageFramework_Resource_Base {
    ...
    protected function _printCommonStyles($sIDPrefix, $sClassName) {
        ...
        $_sStyle = $this->oUtil->addAndApplyFilters($_oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), FetchTweets_AdminPageFramework_CSS::getDefaultCSS());
        $_sStyle = $this->oUtil->minifyCSS($_sStyle);
        if ($_sStyle) {
            echo "<style type='text/css' id='" . esc_attr($sIDPrefix) . "'>" . $_sStyle . "</style>";
        }
        $_sStyleIE = $this->oUtil->addAndApplyFilters($_oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), FetchTweets_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->oUtil->addAndApplyFilters($this->oProp->_getCallerObject(), array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), FetchTweets_AdminPageFramework_Property_Base::$_sDefaultScript);
        if ($_sScript) {
...
class FetchTweets_AdminPageFramework_Resource_Page extends FetchTweets_AdminPageFramework_Resource_Base {
...
class FetchTweets_AdminPageFramework_Resource_MetaBox extends FetchTweets_AdminPageFramework_Resource_Base {
...
class FetchTweets_AdminPageFramework_Resource_MetaBox_Page extends FetchTweets_AdminPageFramework_Resource_Page {
}
class FetchTweets_AdminPageFramework_Resource_PostType extends FetchTweets_AdminPageFramework_Resource_MetaBox {
}
class FetchTweets_AdminPageFramework_Resource_TaxonomyField extends FetchTweets_AdminPageFramework_Resource_MetaBox {
...
class FetchTweets_AdminPageFramework_Resource_UserMeta extends FetchTweets_AdminPageFramework_Resource_MetaBox {
}
...
class FetchTweets_AdminPageFramework_Message {
    ...
    public static function getInstance($sTextDomain = 'admin-page-framework') {
        $_oInstance = isset($_aInstancesByTextDomain[$sTextDomain]) && ($_aInstancesByTextDomain[$sTextDomain] instanceof FetchTweets_AdminPageFramework_Message) ? $_aInstancesByTextDomain[$sTextDomain] : new FetchTweets_AdminPageFramework_Message($sTextDomain);
...
abstract class FetchTweets_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['aFetchTweets_AdminPageFramework'] = isset($GLOBALS['aFetchTweets_AdminPageFramework']) && is_array($GLOBALS['aFetchTweets_AdminPageFramework']) ? $GLOBALS['aFetchTweets_AdminPageFramework'] : array('aFieldFlags' => array());
        $this->sPageNow = FetchTweets_AdminPageFramework_WPUtility::getPageNow();
    ...
    protected function getCallerInfo($sCallerPath = null) {
        ...
        if ('plugin' == $_aCallerInfo['sType']) {
            return FetchTweets_AdminPageFramework_WPUtility::getScriptData($_aCallerInfo['sPath'], $_aCallerInfo['sType']) + $_aCallerInfo;
        }
    ...
    protected function _getLastInput() {
        $_vValue = FetchTweets_AdminPageFramework_WPUtility::getTransient('apf_tfd' . md5('temporary_form_data_' . $this->sClassName . get_current_user_id()));
        if (is_array($_vValue)) {
            return $_vValue;
        }
        return array();
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : FetchTweets_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
...
class FetchTweets_AdminPageFramework_Property_Page extends FetchTweets_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aFetchTweets_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['aFetchTweets_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aFetchTweets_AdminPageFramework']['aPageClasses']) ? $GLOBALS['aFetchTweets_AdminPageFramework']['aPageClasses'] : array();
    ...
    protected function _getOptions() {
        $_aOptions = FetchTweets_AdminPageFramework_WPUtility::addAndApplyFilter($this->oCaller, 'options_' . $this->sClassName, $this->sOptionKey ? get_option($this->sOptionKey, array()) : array());
    ...
    private function _getDefautValue($aField) {
        $_aSubFields = FetchTweets_AdminPageFramework_Utility::getIntegerElements($aField);
...
class FetchTweets_AdminPageFramework_Property_MetaBox extends FetchTweets_AdminPageFramework_Property_Base {
...
class FetchTweets_AdminPageFramework_Property_PostType extends FetchTweets_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        switch ($this->_getCallerType($sCallerPath)) {
            case 'theme':
                add_action('after_switch_theme', array('FetchTweets_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
            break;
            case 'plugin':
                register_activation_hook($sCallerPath, array('FetchTweets_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
                register_deactivation_hook($sCallerPath, array('FetchTweets_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
            break;
        }
    }
}
...
class FetchTweets_AdminPageFramework_Property_NetworkAdmin extends FetchTweets_AdminPageFramework_Property_Page {
    public $_sPropertyType = 'network_admin_page';
    public $sFieldsType = 'network_admin_page';
    protected function _getOptions() {
        return FetchTweets_AdminPageFramework_WPUtility::addAndApplyFilter($GLOBALS['aFetchTweets_AdminPageFramework']['aPageClasses'][$this->sClassName], 'options_' . $this->sClassName, $this->sOptionKey ? get_site_option($this->sOptionKey, array()) : array());
    }
    public function updateOption($aOptions = null) {
        if ($this->_bDisableSavingOptions) {
            return;
...
class FetchTweets_AdminPageFramework_Property_MetaBox_Page extends FetchTweets_AdminPageFramework_Property_MetaBox {
    ...
    function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework', $sFieldsType = 'page_meta_box') {
        ...
        $GLOBALS['aFetchTweets_AdminPageFramework']['aMetaBoxForPagesClasses'] = isset($GLOBALS['aFetchTweets_AdminPageFramework']['aMetaBoxForPagesClasses']) && is_array($GLOBALS['aFetchTweets_AdminPageFramework']['aMetaBoxForPagesClasses']) ? $GLOBALS['aFetchTweets_AdminPageFramework']['aMetaBoxForPagesClasses'] : array();
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        if (!isset($GLOBALS['aFetchTweets_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        if (!is_array($GLOBALS['aFetchTweets_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        foreach ($GLOBALS['aFetchTweets_AdminPageFramework']['aPageClasses'] as $__oClass) {
...
class FetchTweets_AdminPageFramework_Property_TaxonomyField extends FetchTweets_AdminPageFramework_Property_MetaBox {
    public $_sPropertyType = 'taxonomy_field';
    public $aTaxonomySlugs;
    public $sOptionKey;
}
class FetchTweets_AdminPageFramework_Property_UserMeta extends FetchTweets_AdminPageFramework_Property_MetaBox {
    public $_sPropertyType = 'user_meta';
    protected function _getOptions() {
        return array();
    }
}
class FetchTweets_AdminPageFramework_FieldTypeRegistration {
...
abstract class FetchTweets_AdminPageFramework_PageLoadInfo_Base {
...
class FetchTweets_AdminPageFramework_PageLoadInfo_Page extends FetchTweets_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    public static function instantiate($oProp, $oMsg) {
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new FetchTweets_AdminPageFramework_PageLoadInfo_Page($oProp, $oMsg);
...
class FetchTweets_AdminPageFramework_PageLoadInfo_NetworkAdminPage extends FetchTweets_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    function __construct($oProp, $oMsg) {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new FetchTweets_AdminPageFramework_PageLoadInfo_NetworkAdminPage($oProp, $oMsg);
        return self::$_oInstance;
    }
    public function _replyToSetPageLoadInfoInFooter() {
        if ($this->oProp->isPageAdded()) {
...
class FetchTweets_AdminPageFramework_PageLoadInfo_PostType extends FetchTweets_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    public static function instantiate($oProp, $oMsg) {
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new FetchTweets_AdminPageFramework_PageLoadInfo_PostType($oProp, $oMsg);
        return self::$_oInstance;
    }
    public function _replyToSetPageLoadInfoInFooter() {
...
class FetchTweets_AdminPageFramework_Script_Base {
...
class FetchTweets_AdminPageFramework_Script_AttributeUpdator extends FetchTweets_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class FetchTweets_AdminPageFramework_Script_CheckboxSelector extends FetchTweets_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class FetchTweets_AdminPageFramework_Script_CollapsibleSection extends FetchTweets_AdminPageFramework_Script_Base {
...
class FetchTweets_AdminPageFramework_Script_MediaUploader extends FetchTweets_AdminPageFramework_Script_Base {
    public function construct() {
...
class FetchTweets_AdminPageFramework_Script_OptionStorage extends FetchTweets_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class FetchTweets_AdminPageFramework_Script_RegisterCallback extends FetchTweets_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class FetchTweets_AdminPageFramework_Script_RepeatableField extends FetchTweets_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class FetchTweets_AdminPageFramework_Script_RepeatableSection extends FetchTweets_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class FetchTweets_AdminPageFramework_Script_Sortable extends FetchTweets_AdminPageFramework_Script_Base {
    protected function construct() {
...
class FetchTweets_AdminPageFramework_Script_Tab extends FetchTweets_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class FetchTweets_AdminPageFramework_Script_Utility extends FetchTweets_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
class FetchTweets_AdminPageFramework_Script_Widget extends FetchTweets_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
abstract class FetchTweets_AdminPageFramework_PluginBootstrap {
    ...
    protected function _registerClasses() {
        if (!class_exists('FetchTweets_AdminPageFramework_RegisterClasses')) {
            return;
        }
...
abstract class FetchTweets_AdminPageFramework_Utility_String {
...
abstract class FetchTweets_AdminPageFramework_Utility_Path extends FetchTweets_AdminPageFramework_Utility_Array {
...
abstract class FetchTweets_AdminPageFramework_Utility extends FetchTweets_AdminPageFramework_Utility_SystemInformation {
...
class FetchTweets_AdminPageFramework_WPUtility_URL extends FetchTweets_AdminPageFramework_Utility {
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = FetchTweets_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class FetchTweets_AdminPageFramework_WPUtility_SystemInformation extends FetchTweets_AdminPageFramework_WPUtility_Post {
...
class FetchTweets_AdminPageFramework_FormEmail extends FetchTweets_AdminPageFramework_WPUtility {
...
abstract class FetchTweets_AdminPageFramework_Link_Base extends FetchTweets_AdminPageFramework_WPUtility {
...
class FetchTweets_AdminPageFramework_Link_Page extends FetchTweets_AdminPageFramework_Link_Base {
    private $oProp;
...
class FetchTweets_AdminPageFramework_FormElement_Utility extends FetchTweets_AdminPageFramework_WPUtility {
...
class FetchTweets_AdminPageFramework_FormElement extends FetchTweets_AdminPageFramework_FormElement_Utility {
...
abstract class FetchTweets_AdminPageFramework_FieldType_Base extends FetchTweets_AdminPageFramework_WPUtility {
    ...
    protected function geFieldOutput(array $aField) {
        ...
        $_oField = new FetchTweets_AdminPageFramework_FormField($aField, $_aOptions, $_oCaller->getFieldErrors(), $_oCaller->oProp->aFieldTypeDefinitions, $_oCaller->oMsg, $_oCaller->oProp->aFieldCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new FetchTweets_AdminPageFramework_Script_MediaUploader($this->oMsg);
        } else {
...
abstract class FetchTweets_AdminPageFramework_FormOutput extends FetchTweets_AdminPageFramework_WPUtility {
...
class FetchTweets_AdminPageFramework_FormField_Base extends FetchTweets_AdminPageFramework_FormOutput {
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new FetchTweets_AdminPageFramework_Script_Widget;
        ...
        new FetchTweets_AdminPageFramework_Script_Utility;
        new FetchTweets_AdminPageFramework_Script_OptionStorage;
        new FetchTweets_AdminPageFramework_Script_AttributeUpdator;
        new FetchTweets_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new FetchTweets_AdminPageFramework_Script_Sortable;
        new FetchTweets_AdminPageFramework_Script_RegisterCallback;
    }
...
class FetchTweets_AdminPageFramework_FormField extends FetchTweets_AdminPageFramework_FormField_Base {
...
abstract class FetchTweets_AdminPageFramework_Input_Base extends FetchTweets_AdminPageFramework_WPUtility {
    public $aField = array();
...
class FetchTweets_AdminPageFramework_Debug extends FetchTweets_AdminPageFramework_WPUtility {
    ...
    static public function log($vValue, $sFilePath = null) {
        ...
        $_sHeading = date("Y/m/d H:i:s", $_nNow) . '.' . $_nMicroseconds . ' ' . $_sElapsed . '.' . $_sElapsedFloat . ' ' . $_iPageLoadID . ' ' . FetchTweets_AdminPageFramework_Registry::Version . (FetchTweets_AdminPageFramework_Registry::$bIsMinifiedVersion ? '.min' : '') . ' ' . "{$_sCallerClasss}::{$_sCallerFunction} " . current_filter() . ' ' . self::getCurrentURL() . ' ';
...
abstract class FetchTweets_AdminPageFramework_HelpPane_Base extends FetchTweets_AdminPageFramework_Debug {
    protected $_oScreen;
    function __construct($oProp) {
        $this->oProp = $oProp;
        $this->oUtil = new FetchTweets_AdminPageFramework_WPUtility;
...
class FetchTweets_AdminPageFramework_HelpPane_Page extends FetchTweets_AdminPageFramework_HelpPane_Base {
...
class FetchTweets_AdminPageFramework_ExportOptions extends FetchTweets_AdminPageFramework_CustomSubmitFields {
    ...
    public function doExport($vData, $sFileName = null, $sFormatType = null) {
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (is_array($vData) || is_object($vData)) die(FetchTweets_AdminPageFramework_Debug::getArray($vData, null, false));
                die($vData);
            case 'json':
...
class FetchTweets_AdminPageFramework_Link_PostType extends FetchTweets_AdminPageFramework_Link_Base {
    public $aFooterInfo = array('sLeft' => '', 'sRight' => '',);
    public function __construct($oProp, $oMsg = null) {
        if (!$oProp->bIsAdmin) {
            return;
...
class FetchTweets_AdminPageFramework_FormElement_Page extends FetchTweets_AdminPageFramework_FormElement {
...
class FetchTweets_AdminPageFramework_FieldType_image extends FetchTweets_AdminPageFramework_FieldType_Base {
...
class FetchTweets_AdminPageFramework_FieldType_checkbox extends FetchTweets_AdminPageFramework_FieldType {
    ...
    protected function getScripts() {
        new FetchTweets_AdminPageFramework_Script_CheckboxSelector;
    ...
    protected function getField($aField) {
        $_aOutput = array();
        $_oCheckbox = new FetchTweets_AdminPageFramework_Input_checkbox($aField);
...
class FetchTweets_AdminPageFramework_FieldType_radio extends FetchTweets_AdminPageFramework_FieldType {
    ...
    protected function getField($aField) {
        $_aOutput = array();
        $_oRadio = new FetchTweets_AdminPageFramework_Input_radio($aField);
...
class FetchTweets_AdminPageFramework_FieldType_section_title extends FetchTweets_AdminPageFramework_FieldType {
...
class FetchTweets_AdminPageFramework_FieldType_select extends FetchTweets_AdminPageFramework_FieldType {
    ...
    protected function getField($aField) {
        $_oSelectInput = new FetchTweets_AdminPageFramework_Input_select($aField);
...
class FetchTweets_AdminPageFramework_FieldType_taxonomy extends FetchTweets_AdminPageFramework_FieldType {
...
class FetchTweets_AdminPageFramework_FormTable_Base extends FetchTweets_AdminPageFramework_FormOutput {
    ...
    private function _loadScripts() {
        ...
        new FetchTweets_AdminPageFramework_Script_Tab;
    }
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        new FetchTweets_AdminPageFramework_Script_CollapsibleSection($this->oMsg);
    }
    ...
    protected function _getRepeatableSectionsEnablerScript($sContainerTagID, $iSectionCount, $aSettings) {
        ...
        new FetchTweets_AdminPageFramework_Script_RepeatableSection($this->oMsg);
...
class FetchTweets_AdminPageFramework_HelpPane_MetaBox extends FetchTweets_AdminPageFramework_HelpPane_Base {
    function __construct($oProp) {
        parent::__construct($oProp);
        if ($oProp->bIsAdminAjax) {
            return;
...
class FetchTweets_AdminPageFramework_FieldType_size extends FetchTweets_AdminPageFramework_FieldType_select {
    ...
    protected function getField($aField) {
        ...
        $_oUnitInput = new FetchTweets_AdminPageFramework_Input_select($_aUnitField);
...
class FetchTweets_AdminPageFramework_FormTable_Row extends FetchTweets_AdminPageFramework_FormTable_Base {
    ...
    private function _getFieldRow(array $aField, $hfCallback) {
        ...
        return $this->_getFieldByContainer($aField, $_aFieldFinal, $hfCallback, array('open_container' => "<tr " . $this->_getFieldContainerAttributes($_aFieldFinal, array('id' => 'fieldrow-' . FetchTweets_AdminPageFramework_FormField::_getInputTagBaseID($_aFieldFinal), 'valign' => 'top', 'class' => 'admin-page-framework-fieldrow',), 'fieldrow') . ">", 'close_container' => "</tr>", 'open_title' => "<th>", 'close_title' => "</th>", 'open_main' => "<td " . $this->generateAttributes(array('colspan' => $_aFieldFinal['show_title_column'] ? 1 : 2, 'class' => $_aFieldFinal['show_title_column'] ? null : 'admin-page-framework-field-td-no-title',)) . ">", 'close_main' => "</td>",));
    }
    ...
    private function _getFieldTitle(array $aField) {
        return "<label for='" . FetchTweets_AdminPageFramework_FormField::_getInputID($aField) . "'>" . "<a id='{$aField['field_id']}'></a>" . "<span title='" . esc_attr(strip_tags(isset($aField['tip']) ? $aField['tip'] : (is_array($aField['description'] ? implode('&#10;', $aField['description']) : $aField['description'])))) . "'>" . $aField['title'] . (in_array($aField['_fields_type'], array('widget', 'post_meta_box', 'page_meta_box')) && isset($aField['title']) && '' !== $aField['title'] ? "<span class='title-colon'>:</span>" : '') . "</span>" . "</label>";
    }
}
abstract class FetchTweets_AdminPageFramework_FormTable_Caption extends FetchTweets_AdminPageFramework_FormTable_Row {
...
class FetchTweets_AdminPageFramework_FormTable extends FetchTweets_AdminPageFramework_FormTable_Caption {
...
class FetchTweets_AdminPageFramework_HelpPane_MetaBox_Page extends FetchTweets_AdminPageFramework_HelpPane_MetaBox {
    protected function _isInThePage() {
...
class FetchTweets_AdminPageFramework_HelpPane_TaxonomyField extends FetchTweets_AdminPageFramework_HelpPane_MetaBox {
    public function _replyToRegisterHelpTabTextForMetaBox() {
        $this->_setHelpTab($this->oProp->sMetaBoxID, $this->oProp->sTitle, $this->oProp->aHelpTabText, $this->oProp->aHelpTabTextSide);
    }
}
class FetchTweets_AdminPageFramework_HelpPane_UserMeta extends FetchTweets_AdminPageFramework_HelpPane_MetaBox {
}
class FetchTweets_AdminPageFramework_HelpPane_Widget extends FetchTweets_AdminPageFramework_HelpPane_MetaBox {
}