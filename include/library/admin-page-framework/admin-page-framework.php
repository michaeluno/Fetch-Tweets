...
final class FetchTweets_AdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath = __FILE__) {
        ...
        new FetchTweets_AdminPageFramework_RegisterClasses(empty(FetchTweets_AdminPageFramework_Registry::$aClassFiles) ? FetchTweets_AdminPageFramework_Registry::$sDirPath : '', array('exclude_class_names' => array('FetchTweets_AdminPageFramework_MinifiedVersionHeader', 'FetchTweets_AdminPageFramework_BeautifiedVersionHeader',),), FetchTweets_AdminPageFramework_Registry::$aClassFiles);
        FetchTweets_AdminPageFramework_Registry::$bIsDevelopmentVersion = class_exists('FetchTweets_AdminPageFramework_InclusionClassFilesHeader');
    }
